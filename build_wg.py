...
if wg.client and wg.server:
    ...
    if wg.key and wg.endpoint and wg.allow and wg.ip and wg.port:
        ...
        print(Fore.RED+Style.BRIGHT+"Building a client config file requires a -i <ip/cidr> -p <port> -k <public key>, -e <server ip>, and -a <allowed IPS>")
elif wg.server:
    if wg.port and wg.ip:
        ...
        print(Fore.RED+Style.BRIGHT+"Building a server config requires a -i <ip/cidr>, -p <port>")
elif wg.peer:
    if wg.key and wg.allow:
        ...
        print(Fore.RED+Style.BRIGHT+"Adding a Peer to the configuration requires a -k <public key> and -a <allowed IPS>")
else:
